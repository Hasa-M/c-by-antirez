 ...
 * The following functions allocate the Toy Forth objects of different types */

 /* Allocate and initialize a new Toy Fort object */
...
/* Add the new element at the end f the  list'list' */
/* It is up to the caller to increment a reference count of
